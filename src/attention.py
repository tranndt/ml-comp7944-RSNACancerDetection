"""
https://github.com/MasterBin-IIAU/UNINEXT/blob/a6d4cac39401a925a5611812fb1cefdb43760747/projects/UNINEXT/uninext/models/deformable_detr/fuse_helper.py#L142
"""
...
class BiMultiHeadAttention(nn.Module):
    def __init__(self, v_dim, l_dim, embed_dim, num_heads, dropout=0.1, cfg=None):
        ...
        self.clamp_min_for_underflow = False
        self.clamp_max_for_overflow = False
